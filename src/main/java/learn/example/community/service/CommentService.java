...
import learn.example.community.enums.NotificationTypeEnum;
import learn.example.community.exception.CustomizeErrorCode;
import learn.example.community.exception.CustomizeException;
import learn.example.community.mapper.*;
import learn.example.community.model.*;
...
public class CommentService {
    ...
    public void insert(Comment comment, User commentator) {
        ...
        if (comment.getType() == CommentTypeEnum.COMMENT.getType()) {
            ...
            //创建通知
            createNotify(comment, question.getCreator(), commentator.getName(), question.getTitle(), NotificationTypeEnum.REPLY_QUESTUIN, question.getId());
        }
    }
